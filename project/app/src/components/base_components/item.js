    ...
    render() {
        ...
        if (this.props.type !== undefined) {
            if (this.props.type === "user")
                secondary = <p className="fs-7 fw-light text-secondary">{this.props.secondary}</p>
            else if (this.props.type === "history")
                secondary = <p className="fs-7 fw-light text-secondary text-end">{this.props.secondary}</p>
        }
            ...
            <Card className="m-3 my-2 shadow-sm px-0 boxShadow border-light" style={{borderRadius: "15px", width: "90%"}}>
                <Row className="my-2 align-items-center d-flex">
                    ...
                    <Col className="col me-5">
                        ...
                        <p className="fs-6 fw-normal mb-2 text-break">{this.props.main}</p>
                        {secondary}
                    </Col>
                </Row>
            </Card>
