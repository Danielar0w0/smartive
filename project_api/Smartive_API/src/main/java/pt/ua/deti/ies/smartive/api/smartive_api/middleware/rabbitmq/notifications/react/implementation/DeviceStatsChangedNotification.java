...
public class DeviceStatsChangedNotification extends ReactRabbitMQNotification {

    public DeviceStatsChangedNotification(RabbitMQHandler rabbitMQHandler, Object... args) {
    ...
    public void sendNotification() {
        ...
        messageObject.addProperty("notification", ReactNotificationType.DEVICE_STATS_CHANGED.name());
